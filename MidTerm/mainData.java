...
public class mainData {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("6. Display Lecturer Summary");
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    displayLecturerSummary(scheduleList);
                    break;
                case 0:
    ...
    public static void displayLecturerSummary(Schedule[] scheduleList) {
        for (Lecturer lecturer : new Lecturer[]{
                new Lecturer("W001", "Cristiano Ronaldo"),
                new Lecturer("W002", "Kobe Bryant"),
                new Lecturer("W003", "Leonardo Dicaprio"),
                new Lecturer("W004", "Anthony Santos"),
            ...
            for (Schedule schedule : scheduleList) {
                if (schedule.lcr.lecturerName.equals(lecturer.lecturerName)) {
                    totalDuration += schedule.calculateMinute();
                    courseCount++;
                }
            }

            if (courseCount > 0) {
                System.out.println(lecturer.lecturerName + ": Total Teaching Duration = " + totalDuration + " minutes");
                System.out.println("Average Session Duration = " + (totalDuration / courseCount) + " minutes");
            } else {
                System.out.println(lecturer.lecturerName + ": No courses assigned.");
            }
        }
    }
}