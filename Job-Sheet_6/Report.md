...
1. The solution has been implemented in TopStudent17.java and below is the screenshot of the results.
...
1. 1. The modification has been implemented in TopStudent17.java and below is the screenshot of the results.

![JaD](sura/11.png)

**Brief explanation:**
- An InsertionSort method was modified in the TopStudent17.java class to sort the students in descending order based on GPA.
- The comparison condition in the while loop was changed from listStudents[j-1].gpa > temp.gpa to listStudents[j-1].gpa < temp.gpa to ensure that the list is sorted in descending order instead of ascending.
...
**Brief explanation:**
- A class named Lecturer was created with the required attributes and a constructor to initialize them.
- A LecturerData class was implemented to store lecturer objects and provide sorting functionalities using Bubble Sort (ascending by age) and Selection Sort (descending by age).
- A LecturerDemo class was created to run the program, allowing user interaction through a menu-driven system.
- An object of LecturerData was created in LecturerDemo, and both sorting and print methods were called to sort and display lecturer data.
